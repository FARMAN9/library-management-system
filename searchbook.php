...
input:hover{
	...
	<a href="searchbookname.php"><button id="bt1">search book by<br>name</button></a>
	<a href="searchbook.php"align="center"><button id="bt1"style="width:6%;"  >Reload<br>page</button></a>
	<p align="right">
...
if($_POST)
{
	...
	if($code<=0)
	{
		echo"ENTER VALID BOOK_CODE:".$code;
		exit();
	}
